...
2. Package requirements: requirements.txt      
  ...
  opencv-python
  ```
  If you already had the same Pytorch version (pytorch==1.2.0, torchvision==0.4.0), remove these lines in requirements.txt: ```pytorch==1.2.0 and torchvision==0.4.0```.
